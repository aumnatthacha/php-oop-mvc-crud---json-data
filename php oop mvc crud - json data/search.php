    ...
    ?>        
            ...
            <div class="col mb-5">
                <div class="card h-150">
                    <a href="controller/con_view_course.php?identifier=<?=$r->identifier;?>" class="card-link">
                        <!-- Product image-->
                        <img class="card-img-top" src="image/<?=$r->image;?>" alt="" />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-left">
                                ...
                                <!-- course tag line-->
                                <div class="course-note"><i class="far fa-calendar-alt"></i> ปีที่เปิดสอน <?=$r->position;?></div>
                                <div class="course-note"><i class="far fa-calendar-alt"></i> วันที่อบรม <?=$r->team;?></div>
                                ...
                                <div class="course-note"><i class="fas fa-wallet"></i> <?=$r->last_name;?></div>
                            </div>
                        </div>
                    </a>
                </div>
...
?>
    ...
    <footer class="py-5 bg-green">
        <div class="container-fluid">
            ...
            ©2023 Reserved by Buriram United | Privacy Policy | Data Subject Right Request<br>
