    ...
    <header class="bg-or-5 py-1 bg-header-img">
        <div class="container-fluid px-4 px-lg-5 my-5">
            <div class="text-center orange-theme-4">
                <h1 class="display-4 fw-bolder">เพิ่มนักฟุตบอล</h1>
...
<div class="col-md-8">
  ...
  <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" name="first_name" class="form-control" id="first_name" placeholder="ชื่อ">
      </div>
  </div>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">LastName</label>
      <div class="col-sm-10">
        <input type="text" name="last_name" class="form-control" id="last_name" placeholder="นามสกุล">
      </div>
  </div>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">Team</label>
      <div class="col-sm-10">
        <input type="text" name="team" class="form-control" id="team" placeholder="ทีม">
      </div>
  </div>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">Img</label>
      <div class="col-sm-10">
        <input type="text" name="image" class="form-control" id="image" placeholder="รูป">
      </div>
  </div>
